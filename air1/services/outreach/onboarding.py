...
class OnboardingService:
    ...
    def _validate_competitors_format(self, competitors: Optional[str]) -> Optional[str]:
        """
        ...
        # Expected format: "competitor1, competitor2, competitor3"
        ...
        # Each item should be non-empty after stripping
