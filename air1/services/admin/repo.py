...
2. **Unexpected errors**: Any non-database exception indicates a potential bug or
   infrastructure issue. Functions raise QueryError wrapping the original error.
   Callers should let these propagate for investigation.

Return Value Conventions:
- Insert functions: Return dict|None
- Query functions: Return object|None or list
- Update/Delete functions: Return bool or raise on error
"""
