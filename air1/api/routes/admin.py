...
from air1.services.account.user import get_account_by_clerk_id
...
async def _require_admin(current_user: AuthUser) -> dict:
    ...
    result = await account_service.require_admin_access(user_id)
...
async def get_team(current_user: AuthUser = Depends(get_current_user)):
    ...
    result = await account_service.get_team_members(agency_id)
...
async def invite_team_member(
    ...
    result = await account_service.invite_team_member(
        agency_id=agency_id,
...
async def remove_team_member(
    ...
    result = await account_service.remove_team_member(agency_id, member_id)
...
async def resend_invite(
    ...
    result = await account_service.resend_invite(agency_id, member_id)
...
async def update_member_role(
    ...
    result = await account_service.update_member_role(
        agency_id=agency_id,
        member_id=member_id,
...
async def get_clients(
    ...
    result = await account_service.get_clients(
        agency_id=agency_id,
...
async def create_client(
    ...
    result = await account_service.create_client(
        agency_id=agency_id,
        name=request.name,
...
async def get_client(
    ...
    result = await account_service.get_client(agency_id, client_id)
...
async def update_client(
    ...
    result = await account_service.update_client(
        agency_id=agency_id,
        client_id=client_id,
        name=request.name,
        plan=request.plan,
...
async def remove_client(
    ...
    result = await account_service.remove_client(agency_id, client_id)
...
async def impersonate_client(
    ...
    result = await account_service.impersonate_client(
        agency_id=agency_id,
        member_id=member_id,
        client_id=client_id,
    )
